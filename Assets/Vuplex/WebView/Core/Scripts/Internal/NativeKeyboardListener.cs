...
namespace Vuplex.WebView.Internal {
    ...
    public class NativeKeyboardListener : MonoBehaviour {
        ...
        bool _processIme() {
            ...
            if (_previousImeCompositionString == compositionString) {
                ...
                if (Input.inputString.Length > 0 && compositionString != "") {
                    ImeCompositionFinished?.Invoke(this, new EventArgs<string>(compositionString));
            ...
            _previousImeCompositionString = compositionString;
            return true;
        }
