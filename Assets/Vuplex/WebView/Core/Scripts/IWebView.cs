...
namespace Vuplex.WebView {
    ...
    public interface IWebView {
        ...
        ///     the event indicates that a text field has been focused (i.e. `FocusedInputFieldType.Text`). This is because the
        ///     event's implementation is unable detect what type of element within an <iframe> has been focused.
        ///   </item>
        ///   <item>
        ///     For 2D WebView for WebGL, this API is often disabled due to browser limitations.
        ///     For more information, please see <seealso href="https://support.vuplex.com/articles/webgl-limitations">this article</seealso>.
        ///   </item>
        /// </list>
        /// </remarks>
